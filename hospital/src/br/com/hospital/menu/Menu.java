...
public class Menu {
    ...
    public void menuPrincipal() {
        ...
        System.out.println("Descricao do serviço");
        ...
        System.out.println("Valor bruto do serviço: R$" + valorBruto);
    ...
    // private static final String TITULO = "SISTEMA DE GESTAO HOSPITALAR -
    // Sist.NF";
    ...
    // texto.setBorder(BorderFactory.createEmptyBorder(PADDING, PADDING, PADDING,
    // PADDING));
    ...
    // // ─────────────────────────────────────────────
    // private int mostrarOpcoes(String mensagem, String subtitulo, String...
    // rotulos) {
    ...
    // switch (escolha) {
    // case 0 -> JOptionPane.showMessageDialog(null, "Funcao CADASTRAR de " + modulo
    // + " em desenvolvimento.", TITULO, JOptionPane.INFORMATION_MESSAGE);
    // case 1 -> JOptionPane.showMessageDialog(null, "Funcao LISTAR de " + modulo +
    // " em desenvolvimento.", TITULO, JOptionPane.INFORMATION_MESSAGE);
    // case 2 -> JOptionPane.showMessageDialog(null, "Funcao BUSCAR de " + modulo +
    // " em desenvolvimento.", TITULO, JOptionPane.INFORMATION_MESSAGE);
    // case 3 -> JOptionPane.showMessageDialog(null, "Funcao ATUALIZAR de " + modulo
    // + " em desenvolvimento.", TITULO, JOptionPane.INFORMATION_MESSAGE);
    // case 4 -> JOptionPane.showMessageDialog(null, "Funcao EXCLUIR de " + modulo +
    // " em desenvolvimento.", TITULO, JOptionPane.INFORMATION_MESSAGE);
    ...
    // if (escolha == 0) {
    // try {
    // br.com.hospital.conexao.ConnectionFactory cf = new
    // br.com.hospital.conexao.ConnectionFactory();
    // java.sql.Connection conn = cf.getConnection();
    // if (conn != null && !conn.isClosed()) {
    // JOptionPane.showMessageDialog(null, "Conexao com o banco de dados
    // estabelecida com sucesso!", TITULO, JOptionPane.INFORMATION_MESSAGE);
    // conn.close();
    // } else {
    // JOptionPane.showMessageDialog(null, "Nao foi possivel conectar ao banco de
    // dados.", TITULO, JOptionPane.ERROR_MESSAGE);
    // }
    // } catch (Exception e) {
    ...
    // JOptionPane.showMessageDialog(null, info, TITULO + " | SOBRE",
    // JOptionPane.INFORMATION_MESSAGE);
    // }
}
